        ...
        fields: [
            {
                ...
                options: `
                    <div class="import-results">
                        <h4>${result.action_taken === 'matched_existing' ? '🔄 Updated Existing DocType' : '🆕 Created New DocType'}</h4>
                        ...
                        <ul>
                            <li>✅ Success: ${result.import_results.processing_results.success || 0}</li>
                            <li>🔄 Updated: ${result.import_results.processing_results.updated || 0}</li>
                            <li>⏭️ Skipped: ${result.import_results.processing_results.skipped || 0}</li>
                            <li>❌ Failed: ${result.import_results.processing_results.failed || 0}</li>
                        </ul>
                        
                        ${result.recommendations && result.recommendations.length > 0 ? 
                            `<h5>💡 Recommendations:</h5><ul>${result.recommendations.map(r => `<li>${r}</li>`).join('')}</ul>` 
                            : ''
                        }
                    </div>
                `
        ...
        fields: [
            {
                ...
                options: `
                    <div class="manual-request-info">
                        <h4>📝 DocType Creation Request Submitted</h4>
